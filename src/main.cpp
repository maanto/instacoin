...
uint256 hashGenesisBlock("0x3594e8c35dc3cdd29ae024ecd9150f144393ade1fb5a387245bddea5f0d35595");
...
static const int64 nTargetTimespan =  60 * 60; // InstaCoin: 1 hour
static const int64 nTargetSpacing = 60; // InstaCoin: 1 minute blocks
...
/*
block.nTime = 1377484614 
block.nNonce = 273298 
block.GetHash = 3594e8c35dc3cdd29ae024ecd9150f144393ade1fb5a387245bddea5f0d35595
CBlock(hash=3594e8c35dc3cdd29ae0, PoW=00000777d43ef68b4149, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=11dc5d6a9f, nTime=1377484614, nBits=1e0ffff0, nNonce=273298, vtx=1)
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "InstaCoin - The fastest coin in history! -Aug 25, 2013";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1377484614; //epochtime
